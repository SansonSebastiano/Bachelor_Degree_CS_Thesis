...
È stato implementato un metodo che funge da base, quindi personalizzabile, per la visualizzazione delle finestre di dialogo discusse nella Sezione \ref{subsec:alert-dialogs}. \\
