...
Le \gls{apig}\glsoccur rilasciate da \emph{OpenAI} \cite{site:openai} provvedono l'accesso a modelli di \gls{iag}\glsoccur, permettendo agli sviluppatori di integrare un sistema dotato di intelligenza artificiale nelle applicazioni.\\ 
