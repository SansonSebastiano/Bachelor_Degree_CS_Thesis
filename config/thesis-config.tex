...
\setglossarypreamble[main]{
    ...
    Per la definizione della maggioranza di questi termini, è stata utilizzata un'unica fonte di riferimento: \textit{Wikipedia} \cite{site:wikipedia}.\\
    Per i restanti termini, verranno indicate, per ciascuno, le fonti di riferimento.
    \vspace{10pt}
}

\input{appendix/glossary-entries.tex}
...
\newcommand{\glsoccur}{\ap{{\color{blue}[g]}}}
...
\newcommand{\usecasemainactors}[1]{\textbf{\\Attori Principali:} #1. \vspace{4pt}}
\newcommand{\usecasesecondaryactors}[1]{\textbf{\\Attori Secondari:} #1. \vspace{4pt}}
\newcommand{\usecasepre}[1]{\textbf{\\Precondizioni:} #1. \vspace{4pt}}
\newcommand{\usecasedesc}[1]{\textbf{\\Descrizione:} #1 \vspace{4pt}}
\newcommand{\usecasepost}[1]{\textbf{\\Postcondizioni:} #1. \vspace{4pt}}
\newcommand{\usecasealt}[1]{\textbf{\\Scenario Alternativo:} #1. \vspace{4pt}}
\newcommand{\usecaseimg}[1]{\textbf{\\Figura:} #1 \vspace{4pt}}
